...
RUN tlmgr install collection-latexrecommended lmodern setspace epigraph xcolor enumitem xkeyval csquotes etoolbox titlesec biblatex lato logreq biblatex-philosophy crimson latexmk biber fontaxes mweights slantsc babel-portuges xstring
